...
Expected Output:
- produce a concise, three-sentence itinerary that covers key aspects of the trip, such as transportation, accommodations, and suggested activities, aligned with the user's budget, location, and duration.
"""
